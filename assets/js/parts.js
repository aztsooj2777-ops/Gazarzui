...
(function () {
  ...
  GZ.GAMES = [
    { id:"aimag",  name:"Аймаг таних",       emoji:"🗺️", color:"var(--teal)",
      desc:"Монголын бодит газрын зураг дээр аймгийн хилээр нь таньж ол.", skill:"Байрлал, орон зайн санамж" },
    { id:"flags",  name:"Далбаа таних",      emoji:"🚩", color:"var(--terra)",
      desc:"62 улсын жинхэнэ далбааг хараад нэрийг нь тааж, дэлхийн мэдлэгээ тэлээрэй.", skill:"Дэлхийн улс орнууд" },
