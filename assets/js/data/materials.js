...
GZ.MAT_GROUPS = [
  ...
  },
  {
    ...
    desc: "Газрын зураг унших гарын авлага, атлас, зургийн даалгавар. Топографын зураг, изогипс, масштаб, азимуттай ажиллах бүх материал.",
    items: [
    ...
    /* Зураг нэмэхдээ: materials/maps/ дотор файлаа хийгээд энд мөр нэмнэ.
       Жишээ: { t: "Монгол орны байгалийн бүсийн зураг", f: "materials/maps/bus.png", size: "1.2 MB" } */
  },
  {
